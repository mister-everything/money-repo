  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          위에서 고른 설정은 그대로 반영돼요. 검색하듯 목표·수준·집중 포인트만
          적으면 AI가 즉석에서 맞춤 문제를 만들어줘요.
        </p>
...
해설은 정답/오답 이유를 아주 자세하게, 쉬운 말로 설명해 주세요.`}
            className="placeholder:text-xs text-sm sm:text-base min-h-20 resize-none max-h-48 border-none shadow-none bg-transparent! focus-visible:ring-0 focus-visible:ring-offset-0"
          />
